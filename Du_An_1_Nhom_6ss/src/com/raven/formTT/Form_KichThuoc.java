 ...
 * @author MSI
 */
public class Form_KichThuoc extends javax.swing.JFrame {

    /**
     * Creates new form Form_XuatXU
     */
    DefaultTableModel model;
    KichThuocService xxsv= new KichThuocService();
      List<Model_KichThuoc> listxx = new ArrayList<>();
    public Form_KichThuoc() {
     ...
     private static String genMa() {
        ...
        String genXX = "KT" + formattedNumber;
        return genXX;
    }
    private void showData(List<Model_KichThuoc> listXX) {
        int index=1;
            model.setRowCount(0);
            for (Model_KichThuoc xx : listXX) {
                Object row[]={index++,xx.getMaKichThuoc(),xx.getTenKichThuoc()};
                model.addRow(row);
         }
    }
    private void fillThuocTinh(int selected){
            Model_KichThuoc xx= xxsv.selectALll().get(selected);
            txtMaTT.setText(xx.getMaKichThuoc());
            txtTenTT.setText(xx.getTenKichThuoc());
        }
     void addTT(){
          ...
          if(count==0){
          Model_KichThuoc xx= new Model_KichThuoc(ma, ten);
          Model_KichThuoc xx1= xxsv.selectById(txtMaTT.getText());
          if(xx1!=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_KichThuoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_KichThuoc().setVisible(true);
            }
        });
    }
