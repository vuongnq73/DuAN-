...
public class NhanVienService extends InterfaceCRUD<Model_NhanVien, String> {
    ...
    public List<Model_NhanVien> selectByTrangThai(boolean trangThai) {
    ...
    public List<Model_NhanVien> selectByChucVu(boolean chucVu) {
    ...
    public List<Model_NhanVien> selectByGioiTinh(boolean gioiTinh) {
