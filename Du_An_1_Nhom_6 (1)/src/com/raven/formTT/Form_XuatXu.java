 ...
 * @author MSI
 */
public class Form_XuatXu extends javax.swing.JFrame {
    ...
    public Form_XuatXu() {
     ...
     private static String genMa() {
        ...
        String genXX = "XX" + formattedNumber;
        return genXX;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_XuatXu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_XuatXu().setVisible(true);
            }
        });
    }
