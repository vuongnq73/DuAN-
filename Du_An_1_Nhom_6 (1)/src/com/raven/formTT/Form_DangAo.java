 ...
 * @author MSI
 */
public class Form_DangAo extends javax.swing.JFrame {

    /**
     * Creates new form Form_XuatXU
     */
    DefaultTableModel model;
    DangAoService xxsv= new DangAoService();
      List<Model_DangAo> listxx = new ArrayList<>();
    public Form_DangAo() {
        initComponents();
     ...
     private static String genMa() {
        ...
        String genXX = "DA" + formattedNumber;
        return genXX;
    }
    private void showData(List<Model_DangAo> listXX) {
        int index=1;
            model.setRowCount(0);
            for (Model_DangAo xx : listXX) {
                Object row[]={index++,xx.getMaDangAo(),xx.getTenDangAo()};
                model.addRow(row);
         }
    }
    private void fillThuocTinh(int selected){
            Model_DangAo xx= xxsv.selectALll().get(selected);
            txtMaTT.setText(xx.getMaDangAo());
            txtTenTT.setText(xx.getTenDangAo());
        }
     void addTT(){
          ...
          if(count==0){
          Model_DangAo xx= new Model_DangAo(ma, ten);
          Model_DangAo xx1= xxsv.selectById(txtMaTT.getText());
          if(xx1!=null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_DangAo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_DangAo().setVisible(true);
            }
        });
    }
