...
public class Form_ChatLieu extends javax.swing.JFrame {
    ...
    ChatLieuService xxsv= new ChatLieuService();
      List<Model_ChatLieu> listxx = new ArrayList<>();
    public Form_ChatLieu() {
     ...
     private static String genMa() {
        ...
        String genXX = "CL" + formattedNumber;
        return genXX;
    }
    private void showData(List<Model_ChatLieu> listXX) {
        int index=1;
            model.setRowCount(0);
            for (Model_ChatLieu xx : listXX) {
                Object row[]={index++,xx.getMaChatLieu(),xx.getTenChatLieu()};
                model.addRow(row);
         }
    }
    private void fillThuocTinh(int selected){
            Model_ChatLieu xx= xxsv.selectALll().get(selected);
            txtMaTT.setText(xx.getMaChatLieu());
            txtTenTT.setText(xx.getTenChatLieu());
        }
     void addTT(){
          ...
          if(count==0){
          Model_ChatLieu xx= new Model_ChatLieu(ma, ten);
          Model_ChatLieu xx1= xxsv.selectById(txtMaTT.getText());
          if(xx1!=null){
